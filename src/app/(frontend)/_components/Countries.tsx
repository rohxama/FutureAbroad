      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 countries-container">
          <div className="country-card text-center p-6 border rounded-lg shadow-md flex flex-col justify-between items-center">
            <Image src="/static-media/uk.png" alt="UK" width={100} height={100} className="mx-auto mb-4" />
          ...
          <div className="country-card text-center p-6 border rounded-lg shadow-md flex flex-col justify-between items-center">
            <Image src="/static-media/usa.png" alt="USA" width={100} height={100} className="mx-auto mb-4" />
          ...
          <div className="country-card text-center p-6 border rounded-lg shadow-md flex flex-col justify-between items-center">
            <Image src="/static-media/astralia.jpeg" alt="Australia" width={100} height={100} className="mx-auto mb-4" />
